...
class metrics:
    ...
    def precision_recall_curve(self, fig_name):
        ...
        return round(max_prec, 3), round(max_rec, 3), round(max_f1, 3), round(max_f2, 3), detail, max_threshold
    ...
    def get_all_metrices(self):
        ...
        precision, recall, best_f1, best_f2, details, f1_threshold = self.precision_recall_curve("pr_curve.png")
        map = self.MAP_at_K(3)
        mrr = self.MRR()
        return {
            'pk3': pk3,
    ...
    def write_summary(self, exe_time):
        ...
        precision, recall, best_f1, best_f2, details = res['precision'], res['recall'], res['f1'], res['f2'], res['details']
        map, mrr = res['map'], res['mrr']
        summary = "\npk3={}, pk2={},pk1={}, precision={} recall={} best_f1 = {}, best_f2={}, MAP={}, MRR={}, exe_time={},f1_threshold={}\n".format(
            pk3,
            pk2,
            pk1,
            precision,
