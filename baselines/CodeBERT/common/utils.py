...
def evaluate_retrival(model, eval_examples, batch_size, res_dir):
    ...
    best_prec, best_rec, best_f1, best_f2, details, _ = m.precision_recall_curve("pr_curve.png")
    map = m.MAP_at_K(3)

    summary = "\nprecision@3={}, precision={} recall={} best_f1 = {}, best_f2={}, MAP={}\n".format(pk, best_prec, best_rec, best_f1, best_f2, map)
