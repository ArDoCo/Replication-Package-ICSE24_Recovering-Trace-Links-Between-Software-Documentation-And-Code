...
public class ParseCodeAST {
    ...
    private void parseCode() {
        ...
        int classId = 0;
        ArrayList<File> fileList = FileIOUtil.getFileList(config.classDirPath, "java");
        System.out.println(config.classDirPath +" "+fileList.size());
...
//            System.out.println(cls.getClassName() + ":" + fieldEntities.size());
            ...
            FileIOUtil.writeFile(preprocess.doCodeTextProcess(), config.classNameDirPath + "/" + cls.getClassName() + ".txt");
            ...
            FileIOUtil.writeFile(processedFieldNameSb.toString(), config.fieldNameDirPath + "/" + cls.getClassName() + ".txt");

            FileIOUtil.writeFile(fieldTypeSb.toString(), config.unprocessedFieldTypeDirPath + "/" + cls.getClassName() + ".txt");
            FileIOUtil.writeFile(processedFieldTypeSb.toString(), config.fieldTypeDirPath + "/" + cls.getClassName() + ".txt");

            FileIOUtil.writeFile(methodNameSb.toString(), config.unprocessedMethodNameDirPath + "/" + cls.getClassName() + ".txt");
            FileIOUtil.writeFile(processedMethodNameSb.toString(), config.methodNameDirPath + "/" + cls.getClassName() + ".txt");

            FileIOUtil.writeFile(paramNameSb.toString(), config.unprocessedParamNameDirPath + "/" + cls.getClassName() + ".txt");
            FileIOUtil.writeFile(processedParamNameSb.toString(), config.paramNameDirPath + "/" + cls.getClassName() + ".txt");

            FileIOUtil.writeFile(paramTypeSb.toString(), config.unprocessedParamTypeDirPath + "/" + cls.getClassName() + ".txt");
            FileIOUtil.writeFile(processedParamTypeSb.toString(), config.paramTypeDirPath + "/" + cls.getClassName() + ".txt");

            FileIOUtil.writeFile(invokeMethodNameSb.toString(), config.unprocessedInvokeMethodDirPath + "/" + cls.getClassName() + ".txt");
            FileIOUtil.writeFile(processedInvokeMethodNameSb.toString(), config.invokeMethodDirPath + "/" + cls.getClassName() + ".txt");
        } // for
...
//        FileIOUtil.writeFile(preprocess.doReqTextProcess(), config.processedCommentDirPath + "/" + clsName + ".txt");
        ...
        FileIOUtil.continueWriteFile(termPairs, config.commentDirPath + "/" + clsName + ".txt");
    }
